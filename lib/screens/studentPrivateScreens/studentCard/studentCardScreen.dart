...
class StudentCardScreen extends StatefulWidget {
  ...
  const StudentCardScreen(this._studentData, {Key? key}) : super(key: key);
  ...
  Widget _buildFrontCard() {
    return SingleChildScrollView(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          FrontCard(widget._studentData), // Usando studentData corretamente
        ],
      ),
    );
  }
  ...
  Widget _buildBackCard() {
    return SingleChildScrollView(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          BackCard(widget._studentData), // Usando studentData corretamente
        ],
      ),
    );
  }
